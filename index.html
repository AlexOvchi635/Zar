...
<head>
    ...
    <style>
        body {
            margin: 0;
            padding: 0;
            background: url('https://white-worthwhile-nightingale-687.mypinata.cloud/ipfs/bafkreiecu6i7wsyinswlrcwq7wqgkv2wtgbftvkkxur37xly6lzkk5vioi') no-repeat center center fixed;
...
<body>
    <div class="game-container">
        ...
        <div id="gameUI" class="ui-overlay" style="display: none;">
            <!-- All UI in Top Left -->
            <div class="ui-panel top-left" style="display: none;">
                <div>Health:</div>
